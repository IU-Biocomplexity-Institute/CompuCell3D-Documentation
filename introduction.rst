...
One choice is to ignore cells completely, e.g., Physiome [1]_ models tissues as continua with bulk mechanical properties and detailed molecular reaction networks, which is computationally efficient for describing dense tissues and non-cellular materials like bone, extracellular matrix (ECM), fluids, and diffusing chemicals (2, 3), but not for situations where cells reorganize or migrate.
